...
define(function(require, exports, module) {
	...
	function initPullRefreshList() {
		...
		var litemplate =
			"<li class='news-item mui-clearfix' id='{{InfoID}}'><div class='news-info' id='{{InfoID}}'><span class='news-title' id='{{InfoID}}'>{{Title}}</span><div class='news-tagging mui-clearfix' id='{{InfoID}}'><span class='tagging-name' id='{{InfoID}}'>{{Author}}</span><span class='tagging-time' id='{{InfoID}}'>{{InfoDate}}</span></div></div></li>";
		var pageSize = 10;
