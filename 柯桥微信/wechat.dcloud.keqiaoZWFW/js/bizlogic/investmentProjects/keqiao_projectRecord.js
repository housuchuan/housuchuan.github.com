...
define(function(require, exports, module) {
	...
	function initData(isPlus) {
		...
		CommonTools.importFile([
			...
			config.GetToken(function(token){
				Token = token;
				//alert('Token'+Token);alert('OpenID'+OpenID);
	...
	function ajaxEventSteps() {
		var url = config.extraServerUrl + '/AuditXiangMu_KQ/GetXMPhaseList';
		var requestData = {};
	...
	function initPullRefreshList() {
		//默认为公用url和模板
		var getUrl = function() {
			var url = config.extraServerUrl + '/AuditXiangMu_KQ/GetPhaseTaskList';
			console.log('url:' + url);
			return url;
		};
