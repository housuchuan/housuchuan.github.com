...
define(function(require, exports, module) {
	...
	function initPullRefreshList() {
		...
		var pullToRefresh0;
		//默认为公用url和模板
		var url = config.serverUrl + 'AuditXiangMu_KQ/GetPhaseProjectList';
		var litemplate =
		...
		var onClickCallback = function(e) {
			...
			var ResetUrl = basePath + 'html/itemCheck/keqiao_itemDetails.html';
			ejs.page.openPage(ResetUrl, '事项详情', {
				RowGuid: RowGuid,
				TaskGuid: id
			});
		};
