...
define(function(require, exports, module) {
	...
	//列表模板
	var litemplate = '<li class="mui-table-view-cell" id={{InfoID}}><i class="catenum" style="display:none;">{{CateNum}}</i><div class="notice-txt2"><span>{{Title}}</span><span>发布时间：{{InfoDate}}</span></div></li>';
	//每页显示条数
	var PageSize = 10;
	var totalNumCount = 0;
	//离线相关
