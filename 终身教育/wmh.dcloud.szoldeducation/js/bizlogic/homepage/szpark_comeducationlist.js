...
define(function(require, exports, module) {
	...
	var litemplate = '<li class="mui-table-view-cell" id="{{InfoID}}"><div class="suzhou_sqjylist"><span class="suzhou_sqjy_newstitle">{{Title}}</span><div class="mui-ellipsis-2">{{infocontent}}</div></div><div class="suzhou_sqjy_pic"><img data-img-localcache="{{HeadNewsAttachUrl}}"/></div></li>';
	var PageSize = 10;
	var totalNumCount = 0;
	var beginIndex = 0;
	var sessionKey = null;
