...
define(function(require, exports, module) {
	...
	function initData() {
		...
		if(userSession.image) {
			var image = userSession.image;
			Zepto("#head-img").attr("src", image);
		}
	};
	Zepto("#originalDisplay").on('tap', function() {
		//原创展示
		WindowUtil.createWin("szpark_original_display_pad.html", "html_pad/menubar/szpark_original_display_pad.html");
	});
	...
	Zepto("#certificationTraining").on('tap', function() {
		//职业资格认证与培训
