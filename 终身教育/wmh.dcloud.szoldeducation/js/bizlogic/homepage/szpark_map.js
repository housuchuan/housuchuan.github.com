...
define(function(require, exports, module) {
	...
	CommonUtil.initReady(function() {
		//获取home页面传过来的参数
		categoryguid = WindowUtil.getExtraDataByKey("categoryguid");
		ChannelName = WindowUtil.getExtraDataByKey("ChannelName");
		...
		getMapCategory();
		//如果存在，这说明是从home地图分类栏目中传过来的
		if(categoryguid && ChannelName) {
