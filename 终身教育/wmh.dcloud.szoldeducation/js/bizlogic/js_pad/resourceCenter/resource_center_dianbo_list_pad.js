...
define(function(require, exports, module) {
	...
	function getBcloudOrBliveTypeList(type) {
		...
		var url = config.JServerUrl + 'resourceCenter/mobile/resourceCenter/columnCourceList';
		var requestData = {};
	...
	Zepto("#listdata").on('tap', 'li,li span', function(e) {
		...
		//console.log("ClassifyId1" + ClassifyId);
		var data = {
		...
		WindowUtil.createWin('resource_center_course_info_pad.html', 'resource_center_course_info_pad.html', {
