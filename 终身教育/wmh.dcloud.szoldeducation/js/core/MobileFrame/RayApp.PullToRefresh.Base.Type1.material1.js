...
define(function(require, exports, module) {
	...
	//下拉刷新
	var PullToRefreshCoreCustom = require('core/MobileFrame/RayApp.PullToRefresh.Base.Type1');
	//继承
	var PullToRefreshCoreCustom_material = PullToRefreshCoreCustom.PullToRefresh.extend({
		init: function(element, options) {
			this._super(element, options);
			this.options = CommonTools.extend(true, {
				down: {
					tips: {
						colors: ['000000', 'd8ad44', 'd00324', 'dc00b8', '017efc'],
		...
		initPullDownTips: function() {
			var self = this;
			if (CommonTools.isFunction(self.options.down.callback)) {
	...
	exports.PullToRefresh = PullToRefreshCoreCustom_material;
